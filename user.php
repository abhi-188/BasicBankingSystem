...
<head>
	...
	<style>
		...
		body{
			background-image:url("images/perimage.jpg");
    ...
    <button class="primary_btn" style="float: right;">HOME</button>
		...
		&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Personal Details  </h2>
    ...
    <div class="primary_btn">
		...
		<button class="primary_btn" style="float:left;">Go Back</button>
		</a>
	</div>
